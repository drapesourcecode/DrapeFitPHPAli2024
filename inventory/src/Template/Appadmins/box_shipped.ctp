...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <!-- <li><a href="<?php echo HTTP_ROOT . 'appadmins/box_shipped' ?>"> Return listing</a></li> -->
        </ol>
    </section>
    <!-- Main content -->
                                    ...
                                    <td colspan="10">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputName"> Scan Tracking number <span style="color: red;">*</span></label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="<?= HTTP_ROOT; ?>appadmins/boxShipped" class="btn btn-sm btn-primary">See All</a>
                                            </div>
                                            <?= $this->Form->end() ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 92px;">
                                            <?php if ($pages->return_receive_front_desk != 1) { ?>
                                                <a  href="<?= HTTP_ROOT; ?>appadmins/markReturnReceived/<?= $pages->id; ?>"></a>
                                                
                                                <div class="panel-group" id="accordion<?=$li_key;?>">
                                                            <div class="panel panel-default">
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a data-toggle="collapse" data-parent="#accordion<?=$li_key;?>" href="#collapseOne<?=$li_key;?>" class="btn btn-info" style="color: #fff;">
                                                                            Mark Return Received</a>
                                                                    </h4>
                                                                </div>
                                                                <div id="collapseOne<?=$li_key;?>" class="panel-collapse collapse">
                                                                    <div class="panel-body">
                                                                        <?= $this->Form->create('',['type'=>'post',"style"=>"padding-top: 10px;", 'url'=>['action'=>'processMarkComplete']]); ?>
                                                                        <input type="hidden" name="id" value="<?=$pages->id;?>" >
                                                                        <select name="inv_user">
                                                                            <option value="" selected disabled >Assign to inventory user</option>
                                                                            <?php foreach($employee_inv as $inv_li){ ?>
                                                                            <option value="<?=$inv_li->id;?>" <?=($pages->return_process_inv_user == $inv_li->id )?"selected":"";?> ><?=$inv_li->name;?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                        <button type="submit" class="btn-sm btn btn-success" style="margin-top: 5px;">Mark Received</button>
                                                                        <?= $this->Form->end(); ?>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <?php } else {
                                                if ($pages->return_receive_front_desk == 1) {
                                                    echo "Retun received";
                                                }
                                            } ?>
                                        </td>
...
<script>
    $("form#idForm").on("submit", function(event) {
        ...
        if (id) {
            var url = "<?php echo HTTP_ROOT . "appadmins/box_shipped/" ?>" + id;
