...
/*<style>*/
    /*#profile_data .btn-success{display:none}*/
/*</style>*/
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
<div class="content-wrapper">
    <section class="content-header">
        <h1>Product Scan & Update Details</h1>        
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-body">
                        <?php if($editproduct->is_deleted== 1){ }else{ ?>
                        <?= $this->Form->create('', ['type' => 'GET', 'id' => 'scan_product']); ?>
                        <?php } ?>
                        <div class="form-group row">
                            <div class="col-sm-2"></div>
                            <label class="col-sm-2">Product scan</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="scan_code" name="product_value" value="<?= !empty($_GET['product_value']) ? $_GET['product_value'] : ''; ?>">
                            </div>
                        </div>
    ...
    <?php if (!empty($_GET['product_value']) && empty($editproduct)) { ?>
        <section style="margin-top: 20px; padding: 10px; ">
            <div class="row">
                <div class="col-xs-12">
                                ...
                                <div class="col-xs-12">
                                    <div class="box box-primary">
                                        <div class="box-body">
                                            ...
                                            <?= $this->Form->input('id', ['value' => $editproduct->id, 'type' => 'hidden', 'label' => false]); ?>
                                            <div class="nav-tabs-custom">
                                                <select name="" class="form-control" onchange=" return getChanges(this.value)">
                                                    ...
                                                    <?php if (@$profile == 'BoyKids') { ?>
                                                        <option selected value="BoyKids">Boy Kids</option>
                                                    <?php } ?> 
                                                    <?php if (@$profile == 'GirlKids') { ?>
                                                        <option selected value="GirlKids">Girl Kids</option>
                                                    <?php } ?> 
                                                </select>
                                                <?php
                                                $edt_dtl = [];
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1">Product12 Category</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1">Height range</label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="exampleInputPassword1">Weight range</label>
                                                                    <div class="women-select-boxes">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="quantity" id="quantity" class="form-control">
                                                                            <option value="0" <?=(@$editproduct->quantity==0) ?"selected":"";?> >0</option>
                                                                            <option value="1" <?=(@$editproduct->quantity==1) ?"selected":"";?>  >1</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php if (@$editproduct->product_image) { ?>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <p><a onclick="return confirm('Are you sure want to delete ?')" href="<?php echo HTTP_ROOT . 'appadmins/editproductimgdelete/Men/' . @$id ?>"><img src="<?php echo HTTP_ROOT . 'img/trash.png' ?>"/></a></p>
                                                                        </div>  
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="btn-group btn-group-toggle"  id="wom_outfit_wer"  data-toggle="buttons" style="float: left;width: 100%;">
                                                                        <label class="btn btn-secondary  <?php if (empty($editproduct->outfit_prefer)) { ?> active <?php } ?>" for="wmens12300" onclick="updateOutfitWomenChkbox()" style="float: left;width: 12.5%;height: 165px;align-items: center;display: flex;">
                                                                            <input type="checkbox" name="outfit_prefer[]" autocomplete="off" value="NULL"  <?php if (!empty($editproduct->outfit_prefer) && in_array('NULL', json_decode($editproduct->outfit_prefer, true))) { ?> checked <?php } ?> id="wmens12300"> None
                                                                        </label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php if (@$editproduct->product_image) { ?>
                                                                        <div class="form-group">                                                        
                                                                            <img src="<?php echo HTTP_ROOT . PRODUCT_IMAGES; ?><?php echo @$editproduct->product_image; ?>" style="width: 50px;"/>
                                                                            <p><a onclick="return confirm('Are you sure want to delete ?')" href="<?php echo HTTP_ROOT . 'appadmins/editproductimgdelete/Women/' . @$id ?>"><img src="<?php echo HTTP_ROOT . 'img/trash.png' ?>"/></a></p>
                                                                        </div>                                    
                                                                    <?php } else { ?>
                                                                        <div class="form-group">
                                                                            <?= $this->Form->input('product_image', ['type' => 'file', 'id' => 'image', 'label' => false, 'kl_virtual_keyboard_secure_input' => "on"]); ?>                                        
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php if (@$editproduct->product_image) { ?>
                                                                        <div class="form-group">
                                                                            <img src="<?php echo HTTP_ROOT . PRODUCT_IMAGES; ?><?php echo @$editproduct->product_image; ?>" style="width: 50px;"/>
                                                                            <p><a onclick="return confirm('Are you sure want to delete ?')" href="<?php echo HTTP_ROOT . 'appadmins/editproductimgdelete/BoyKids/' . @$id ?>"><img src="<?php echo HTTP_ROOT . 'img/trash.png' ?>"/></a></p>
                                                                        </div>                                    
                                                                    <?php } else { ?>
                                                                        <div class="form-group">
                                                                            <?= $this->Form->input('product_image', ['type' => 'file', 'id' => 'image', 'label' => false, 'kl_virtual_keyboard_secure_input' => "on"]); ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php if (@$editproduct->product_image) { ?>
                                                                        <div class="form-group">
                                                                            <img src="<?php echo HTTP_ROOT . PRODUCT_IMAGES; ?><?php echo @$editproduct->product_image; ?>" style="width: 50px;"/>
                                                                            <p><a onclick="return confirm('Are you sure want to delete ?')" href="<?php echo HTTP_ROOT . 'appadmins/editproductimgdelete/GirlKids/' . @$id ?>"><img src="<?php echo HTTP_ROOT . 'img/trash.png' ?>"/></a></p>
                                                                        </div>                                    
                                                                    <?php } else { ?>
                                                                        <div class="form-group">
                                                                            <?= $this->Form->input('product_image', ['type' => 'file', 'id' => 'image', 'label' => false, 'kl_virtual_keyboard_secure_input' => "on"]); ?>                                        
