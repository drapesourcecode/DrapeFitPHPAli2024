...
//        print_r($all_employee_wrk_prds);exit;
    ...
    public function approveEmployeeWork() {
     ...
     public function moveInventory($prod_id) {
        ...
        $this->InProducts->updateAll(['is_active' => 1, 'available_status' => 1, 'match_status' => 2,'is_merchandise' => 0,'po_status' => 4, 'is_clearance' => null], ['prod_id' => $prod_id, 'is_merchandise' => 1]);
