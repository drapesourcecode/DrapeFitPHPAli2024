<script>
    function getChanges(value, category = '') {
        if (value) {
            ...
            window.location.href = url + "appadmins/merchant_product_list/" + value + "/" + category;
        }
    }
</script>
...
<div class="content-wrapper">
    ...
    <!--                                                <option value="prod_id" <?= (!empty($_GET['search_for']) && ($_GET['search_for'] == "prod_id")) ? "selected" : ""; ?> >Prod id</option> -->
                                        ...
                                        <a href="<?= HTTP_ROOT; ?>appadmins/merchant_product_list/Men" class="btn btn-sm btn-primary">See All</a>
                                    </div>
                                    <?= $this->Form->end() ?>
                                </div>
                            </div>
                ...
                <!-- <td><?php echo $pdetails->user_id ?></td> -->
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <?= $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-list')), ['action' => 'listProduct', $pdetails->prod_id,'?'=>['merchant'=>'1']], ['escape' => false, "data-placement" => "top", "data-hint" => "View all products", 'class' => 'btn btn-primary hint--top  hint', 'style' => 'padding: 0 7px!important;']); ?>
                                               ...
                                               <a href="<?php echo HTTP_ROOT . 'appadmins/move_inventory/' . $pdetails->prod_id; ?>">
                                                <?= $this->Form->button('Move to Inventory', ["data-placement" => "top", "data-hint" => "Move to Inventory", 'class' => "btn btn-success hint--top hint"]) ?>
                                            </a>
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                Quantity : 
                                                                <?php
                                                                echo $this->Custom->productQuantityM($pdetails->prod_id);
                                                                ?>
                                                            </div>
                                                        </div>
                                                        <div class="row">
    ...
    <!--                                                <option value="prod_id" <?= (!empty($_GET['search_for']) && ($_GET['search_for'] == "prod_id")) ? "selected" : ""; ?> >Prod id</option> -->
                                        ...
                                        <input style="height: 35px; width: 250px;font-weight: bold;" type="text"  name="search_data" autocomplete="off" placeholder="search" value="<?= (!empty($_GET['search_data'])) ? $_GET['search_data'] : ""; ?>" required >
                                        <button type="submit" class="btn btn-sm btn-info">Search</button>
                                        <a href="<?= HTTP_ROOT; ?>appadmins/merchant_product_list/Women" class="btn btn-sm btn-primary">See All</a>
                                    </div>
                                    <?= $this->Form->end() ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div  class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="height: 35px; width: 250px;font-weight: bold;" type="text"  name="search_data" autocomplete="off" placeholder="search" value="<?= (!empty($_GET['search_data'])) ? $_GET['search_data'] : ""; ?>" required >
                                        <button type="submit" class="btn btn-sm btn-info">Search</button>
                                        <a href="<?= HTTP_ROOT; ?>appadmins/merchant_product_list/BoyKids" class="btn btn-sm btn-primary">See All</a>
                                    </div>
                                    <?= $this->Form->end() ?>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div  class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input style="height: 35px; width: 250px;font-weight: bold;" type="text"  name="search_data" autocomplete="off" placeholder="search" value="<?= (!empty($_GET['search_data'])) ? $_GET['search_data'] : ""; ?>" required >
                                        <button type="submit" class="btn btn-sm btn-info">Search</button>
                                        <a href="<?= HTTP_ROOT; ?>appadmins/merchant_product_list/GirlKids" class="btn btn-sm btn-primary">See All</a>
                                    </div>
                                    <?= $this->Form->end() ?>
                                </div>
                            </div>
