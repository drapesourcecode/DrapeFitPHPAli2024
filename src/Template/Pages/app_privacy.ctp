...
<p>DRAPEFIT built the DRAPEFIT app as a free app. This SERVICE is provided by DRAPEFIT and is intended
    for use as is.</p>
...
<p>For a better experience while using our Service, we may require you to provide us with certain
    personally identifiable information, including  name | address | email | phone number. 
	</p>
