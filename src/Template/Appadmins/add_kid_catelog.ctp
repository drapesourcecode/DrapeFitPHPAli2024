                                            ...
                                            <div class="col-sm-6 col-lg-6 col-md-6 first-three">
                                                ...
                                                <?php if($countProduct < 5): ?>
                                                    ...
                                                    <?php endforeach; ?>
                                                            ...
                                                            <p id='p-des'>
                                                                Hello <?php echo $paymentDetails->user->name ?> ! I'm <?php echo $paymentDetails->emply->name ?> , Your boy <?php echo $paymentDetails->kid->kids_first_name ?> Drape Fit Stylist . I picked some colorful  staples for his Personalized Fit Box. I picked One <?php echo $oneProduct; ?>, One <?php echo $twoProduct; ?> , One <?php echo $threeProduct; ?> and One <?php echo $fourProduct; ?> for him. These all staples are perfect for this season.These all staples will be easily paired with <?php echo $fiveProduct; ?>. Hope your boy will love to try all these staples at home . Can't wait to hear from you .  Please don't forget to share his Fit Photos in social media and tag us #drapefit . Have a Stylish day ! 
-XOXO , <?php echo $paymentDetails->emply->name ?>.
                                                            </p>
                                                           <?php else: ?>
                                                    <p id='p-des'>
