                                ...
                                <div class="cat-log">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="col-sm-12 col-lg-12 col-md-12 first-three">
                                            <div class="cat-log-smallbox"> 
                                                <div class="catlog-para">
                                                    <?php if (empty($catelogDetails->contain)) : ?>
                                                        <?php if (empty($paymentDetails->prod)) : ?>
                                                            <p id='p-des'>
                                                                Insufficient products to display the message.
                                                            </p>
                                                        <?php else : ?>
                                                            <?php $countProduct = count($paymentDetails->prod); ?>
                                                            <?php if ($countProduct < 5) : ?>
                                                                <?php foreach($paymentDetails->prod as $key => $product): ?>
                                                                    <?php if ($key < 5): ?>
                                                                        <?php 
                                                                        $displayKey = $key + 1;
                                                                        ?>
                                                                        <?php if ($displayKey == 1): ?>
                                                                            <?php $oneProduct = $product->product_name_one; ?>
                                                                        <?php elseif ($displayKey == 2): ?>
                                                                            <?php $twoProduct = $product->product_name_one; ?>
                                                                        <?php elseif ($displayKey == 3): ?>
                                                                            <?php $threeProduct = $product->product_name_one; ?>
                                                                        <?php elseif ($displayKey == 4): ?>
                                                                            <?php $fourProduct = $product->product_name_one; ?>
                                                                        <?php elseif ($displayKey == 5): ?>
                                                                            <?php $fiveProduct = $product->product_name_one; ?>
                                                                        <?php endif; ?>
                                                                    <?php endif; ?>
                                                                <?php endforeach; ?>
                                                                <?php if ($paymentDetails->profile_type == 1) : ?>
                                                                    <p id='p-des'>
                                                                        Hello <?php echo $paymentDetails->user->name ?> , I'm <?php echo $paymentDetails->emply->name ?> . 
                                                                        I choose to mix and match colors and staples styles for your Personalized Fit Box. 
                                                                        I picked <?php echo $oneProduct; ?>, <?php echo $twoProduct; ?> for your casual winter look. 
                                                                        These all staples are perfect for this season. They all will be easy to pair with <?php echo $threeProduct; ?> from your Fit Box. 
                                                                        To Complete the look I added One <?php echo $fourProduct; ?> for you. 
                                                                        I hope you will enjoy trying all styles and love your Fit Box. Can't wait to hear from you. 
                                                                        Please don't forget to share your Fit Photos on social media and tag us #drapefit. 
                                                                        Happy Styling! XOXO - <?php echo $paymentDetails->emply->name ?>.
                                                                    </p>
                                                                <?php endif; ?>
                                                                <?php if ($paymentDetails->profile_type == 2) : ?>
                                                                    <p id='p-des'>
                                                                        Hello <?php echo $paymentDetails->user->name ?> ! I'm <?php echo $paymentDetails->emply->name ?> , your Drape Fit Stylist . I choose to mix and match colors and staples   for your Personalized Fit Box  . I picked One <?php echo $oneProduct; ?> and <?php echo $twoProduct; ?> for your perfect look . These all staples will be easy to pair with <?php echo $threeProduct; ?> from your Fit Box .These all are perfect for this season. For weekend outing I also added One <?php echo $fourProduct; ?> .To Complete the look I added One <?php echo $fiveProduct; ?> for you .I hope you will enjoy trying all styles and love your Fit Box. Can't wait to hear from you. Please don't forget to share your Fit Photos in social media and tag us #drapefit . Happy Styling ! XOXO - <?php echo $paymentDetails->emply->name ?>.
                                                                    </p>
                                                                <?php endif; ?>
                                                            <?php else : ?>
                                                                <p id='p-des'>
                                            ...
                                            <?php foreach($allProductData as $key => $data){ ?>
                                            <div class="col-sm-6 col-lg-6 col-md-6">
                                                <div class="cat-log-smallbox"> 
                                                    <div class="catlog-product-img">

                                                        <ul style=" overflow: hidden;height: 145px;   margin-bottom: 20px;">
                                                            <li><img  width="200" src="<?php echo HTTP_ROOT . 'inventory/files/product_img/' . $data->product_image; ?>"></li>
                                                    ...
                                                    <h6 class='texth'  data-id ='1' id="sec_text1"><?= $data->product_name_one ?></h6>
