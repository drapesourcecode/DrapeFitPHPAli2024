...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <?= __('Ready to ship List') ?>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo HTTP_ROOT . 'appadmins' ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo HTTP_ROOT . 'appadmins/readyToShipList' ?>"> Ready to ship list</a></li>
        </ol>
    </section>
    <!-- Main content -->
                                    ...
                                    <td colspan="10">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="<?= HTTP_ROOT; ?>appadmins/readyToShipList" class="btn btn-sm btn-primary">See All</a>
                                            </div>
                                            <?= $this->Form->end() ?>
