        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <!--                                                    <a href="<?php echo HTTP_ROOT . 'appadmins/df_matching/' . @$pages->id; ?>" data-placement="top"  class="btn btn-info" ><i class="fa fa-magic" aria-hidden="true"></i>DF Matching</a>-->
                                        ...
                                        <?php if($pages->work_flow_status == Configure::read('Cant_Ship_now')){ ?>                
                                        <a href="<?= HTTP_ROOT; ?>appadmins/updateWorkFlowStatusOnboarding/<?= $pages->id; ?>" class="btn btn-info" >Move to Onboarding</a>
                                        <?php } ?>
