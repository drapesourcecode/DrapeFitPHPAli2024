                                ...
                                <?php foreach ($productdetails as $list): ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <?php if ($list->keep_status == 2 && $list->is_complete == 1 && $list->checkedout == "N") { ?><br>
                                                <?php if (@$list->kid_id != 0) { ?>
<?php /* ?>
                                                    <a  href="<?php echo HTTP_ROOT . 'appadmins/addkid_profile/' . @$list->payment_id . '/' . @$list->kid_id; ?>?exchange=<?php echo @$list->id; ?>" class="btn btn-primary" id="addhref">Add Product</a>
                                                    <?php */ ?>

                                                    <a  href="<?php echo HTTP_ROOT . 'appadmins/matching/' . @$list->payment_id . '/'; ?>?exchange=<?php echo @$list->id; ?>" class="btn btn-primary" id="addhref">Matching Products</a>

                                                    <a   href="<?php echo HTTP_ROOT . 'appadmins/browse_products/' . @$list->payment_id; ?>?exchange=<?php echo @$list->id; ?>" data-placement="top"  class="btn btn-info" ><i class="fa fa-magic" aria-hidden="true"></i> Browse All</a>

                                                <?php } else { ?>
                                                    <?php /* ?>
                                                    <a  href="<?php echo HTTP_ROOT . 'appadmins/addproduct/' . @$list->payment_id ?>?exchange=<?php echo @$list->id; ?>" class="btn btn-primary" id="addhrefkid">Add Product</a> 
<?php */ ?>
                                                    <a  href="<?php echo HTTP_ROOT . 'appadmins/matching/' . @$list->payment_id ?>?exchange=<?php echo @$list->id; ?>" class="btn btn-primary" id="addhrefkid">Matching Products</a> 
