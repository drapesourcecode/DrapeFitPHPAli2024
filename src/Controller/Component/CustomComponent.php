...
//    }
    ...
    function SubscriptionActivatedEmail($msg, $name, $sitename, $sub_frq=null) {
        ...
        if (strstr($msg, "[SUBSCRIPTION_MONTH]")) {

            $msg = str_replace("[SUBSCRIPTION_MONTH]", $sub_frq, $msg);
        }
    ...
    function KIdsSubscriptionActivatedEmail($msg, $name, $kidname, $sitename, $sub_frq=null) {
