...
<?php if(!empty($_GET['sub_ctg']) || (!empty($editproduct) && !empty($editproduct->rack)) ){ ?>
    ...
    <?= $this->Form->input('product_name_two', ['value' => @$editproduct->product_name_two, 'type' => 'text', 'class' => "form-control", 'label' => false, 'placeholder' => 'Please enter product name 2', 'maxlength' => "40"]); ?>
                                                ...
                                                function showSizeBox(id){
                                                    ...
                                                    let new_size_html =`<div class="row"  id="color_size_div${inx_numx}">
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="size[${value}][size][]" id="var_sizes${inx_numx}" onchange="showDetailsBox(${inx_numx},${id});$('.add_more_btn${id}').show();" class="form-control" required>
                                                            <option value="" selected disabled>----</option>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="women-select-boxes">
                                                                                <div class="women-select1">
                                                                                    <select name="tall_feet[${color_value}][${value}][tall_feet1]" id="tall_feet" class="form-control" required>
                                                                                ...
                                                                                <div class="women-select1">
                                                                                    <select name="tall_inch[${color_value}][${value}][tall_inch1]" id="tall_inch" class="form-control">
                                                                                        <option  value="" disabled>--</option>
                                                                                ...
                                                                                <div class="women-select1">
                                                                                    ...
                                                                                    <select name="tall_feet2[${color_value}][${value}][tall_feet2]" id="tall_feet2" class="form-control" required>
                                                                                        <option  value="" disabled>--</option>
                                                                                        <option  value="4">4</option>
                                                                                        <option  value="5">5</option>
                                                                                        <option  value="6">6</option>
                                                                                ...
                                                                                <div class="women-select1">
                                                                                    <select name="tall_inch2[${color_value}][${value}][tall_inch2]" id="tall_inch2" class="form-control">
                                                                                        <option  value="" disabled>--</option>
                                                                                        <option  value="0">0</option>
                                                                                        <option  value="1">1</option>
                                                                                        <option  value="2">2</option>
                                ...
                                <input name='best_fit_for_weight[${color_value}][${value}][best_fit_for_weight1]' value  = '' type = 'text' class = "form-control" placeholder ='Please enter your weight' required>                                                            
                                                                                </div>
                                                                                <span>to</span>
                                                                                <div class="women-select2">
                                <input name='best_fit_for_weight2[${color_value}][${value}][best_fit_for_weight2]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter your weight' required >
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="women-select-boxes">
                                                                                <div class="women-select2">
                               <input name='age1[${color_value}][${value}][age1]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter your age' required >                                                           
                                                                                </div>
                                                                                <span>to</span>
                                                                                <div class="women-select2">
                               <input name='age2[${color_value}][${value}][age2]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter your age' required > 
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                   ...
                                   <input name='age2[${color_value}][${value}][purchase_price]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter purchase price' required > 
                                    ...
                                    <div class="col-md-12">
                                       ...
                                       <input name='age2[${color_value}][${value}][sale_price]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter sale price' required > 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                           ...
                                           <input name='age2[${color_value}][${value}][clearance_price]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter sale price' required > 
                                    ...
                                    <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input name='age2[${color_value}][${value}][quantity]'  value = '' type = 'text' class = "form-control"  placeholder = 'Please enter quantity' required min = "0" steps='1'> 
