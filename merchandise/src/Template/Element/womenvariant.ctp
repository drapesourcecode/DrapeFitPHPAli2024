    ...
    <?php } ?>                                                        
                               ...
                               <input name='variant_data[${color_value}][${value}][age2]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter your age' required > 
                                   ...
                                   <input name='variant_data[${color_value}][${value}][purchase_price]'  value = '' type = 'text' class = "form-control" placeholder = 'Please enter purchase price' required > 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Shoulder size in inches</label>
                                            <input name="variant_data[${color_value}][${value}][shoulder_size_inch]" type="text">
                                        </div>  
                                    </div>  
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Arm size in inches</label>
                                            <input name="variant_data[${color_value}][${value}][arm_size_inch]" type="text">
                                        </div>  
                                    </div> 
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Bust size in inches</label>
                                            <input name="variant_data[${color_value}][${value}][bust_size_inch]" type="text">
                                        </div>  
                                    </div> 
                                    <?php } ?>
