                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row" >
                                                        ...
                                                        <?php if(in_array($product_ctg_nme,["A4","A5", "A7", "A8", "A10"])){ ?>
                                                        <div class="col-sm-6"   >
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <?php if(in_array($product_ctg_nme,["A1", "A9", "A11", "A12", "A14"])/* || in_array($product_sub_ctg_nme, ["A43", "A45", "A44", "A46", "A1411"])*/ ){ ?>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="product_status" class="form-control">
                                                    ...
                                                    <option <?php if (@$editproduct->is_clearance == 'F') { ?> selected="" <?php } ?> value="F"><?=Configure::read('F');?></option> 
                                                </select>
                                            </div>
                                        </div>
