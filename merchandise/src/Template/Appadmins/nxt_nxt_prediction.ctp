                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <a href="<?php echo HTTP_ROOT . 'appadmins/current_prediction' ?>" class="btn btn-default"><?= date('F'); ?></a>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?= (date('m',strtotime($p_c_list->created_dt)) == date('m'))?($p_c_list->count+3):($p_c_list->count+4); ?></td>
                                                                        ...
                                                                        <td><a href="<?= HTTP_ROOT; ?>appadmins/prediction_matching/<?= $p_c_list->id; ?>" data-placement="top" class="btn btn-info"><i class="fa fa-magic" aria-hidden="true"></i> Matching</a> <br>
                                                                            ...
                                                                            <?php if ($totalAllocations > 0) : ?>
                                                                                <a href="<?= HTTP_ROOT; ?>appadmins/prediction_alloca/<?=  $p_c_list->id . '/' . $p_c_list->user_id . '/' . $p_c_list->kid_id ?>" data-placement="top" class="btn btn-info">
                                                                                    <i class="fa fa-magic" aria-hidden="true"></i> + <?= $totalAllocations ?> allocated
...
<!--                                                                        <td><?php //echo  empty($p_c_list->work_flow_status)?'':Configure::read($p_c_list->work_flow_status); ?></td>-->
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>2</td>
                                                                        <td><?= date('Y-' . $one_nxt_month . '-d', strtotime($p_c_list->created_dt)); ?></td>
                                                                        <td><?= (date('m',strtotime($p_c_list->created_dt)) == date('m'))?($p_c_list->count+2):($p_c_list->count+3); ?></td>
                                                                        <td><?= ($p_c_list->usr->is_influencer == 1)?"YES":"NO"; ?></td>
                                                                        <td><a href="<?= HTTP_ROOT; ?>appadmins/prediction_matching/<?= $p_c_list->id; ?>" data-placement="top" class="btn btn-info"><i class="fa fa-magic" aria-hidden="true"></i> Matching</a> <br>
                                                                            <a href="<?php echo HTTP_ROOT . 'appadmins/browse_products/' . $p_c_list->id; ?>" data-placement="top" class="btn btn-info"><i class="fa fa-magic" aria-hidden="true"></i> Browse All</a> <br>
                                                                            <?php
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>3</td>
                                                                        <td><?= date('Y-' . $one_nxt_month . '-d', strtotime($p_c_list->created_dt)); ?></td>
                                                                        <td><?= (date('m',strtotime($p_c_list->created_dt)) == date('m'))?($p_c_list->count+1):($p_c_list->count+2); ?></td>
                                                                        <td><?= ($p_c_list->usr->is_influencer == 1)?"YES":"NO"; ?></td>
                                                                        <td><a href="<?= HTTP_ROOT; ?>appadmins/prediction_matching/<?= $p_c_list->id; ?>" data-placement="top" class="btn btn-info"><i class="fa fa-magic" aria-hidden="true"></i> Matching</a> <br>
                                                                            <a href="<?php echo HTTP_ROOT . 'appadmins/browse_products/' . $p_c_list->id; ?>" data-placement="top" class="btn btn-info"><i class="fa fa-magic" aria-hidden="true"></i> Browse All</a> <br>
                                                                            <?php
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?= ($p_c_list->usr->is_influencer == 1)?"YES":"NO"; ?></td>
                                                                        <td><a href="<?= HTTP_ROOT; ?>appadmins/prediction_matching/<?= $p_c_list->id; ?>" data-placement="top" class="btn btn-info"><i class="fa fa-magic" aria-hidden="true"></i> Matching</a> <br>
                                                                            <a href="<?php echo HTTP_ROOT . 'appadmins/browse_products/' . $p_c_list->id; ?>" data-placement="top" class="btn btn-info"><i class="fa fa-magic" aria-hidden="true"></i> Browse All</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="cmt-frm">
                    ...
                    <input type="hidden" id="month_year" value="<?=date('Y_').date('m', strtotime('first day of +3 month'));?>" />
