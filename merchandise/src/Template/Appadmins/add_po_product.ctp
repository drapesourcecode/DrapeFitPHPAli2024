...
<script>
    function getChanges(value) {
        if (value) {
            ...
            window.location.href = url + "appadmins/addPoProduct/" + value;
        }
    }
</script>
<style>
...
<script type="text/javascript">
    ...
    function setSubCatg(id){
        ...
        if (id) {
             var url = '<?php echo HTTP_ROOT ?>';
             window.location.href = url + "appadmins/addPoProduct/" + user_type+'?ctg='+ctg+'&sub_ctg='+id;
         }
    }
    ...
    function getSubCatg(id) {
        ...
        if (id) {
             var url = '<?php echo HTTP_ROOT ?>';
             window.location.href = url + "appadmins/addPoProduct/" + user_type+'?ctg='+id;
         }
        $.ajax({
            url: '<?php echo HTTP_ROOT ?>appadmins/getSubCatgList',
            type: 'POST',
