                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <a href="<?php echo HTTP_ROOT . 'appadmins/prediction' ?>" class="btn btn-info"><?= date('F', strtotime('first day of +1 month')); ?></a>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?= $p_c_list->parent_detail->first_name . ' ' . $p_c_list->parent_detail->last_name; ?> 
