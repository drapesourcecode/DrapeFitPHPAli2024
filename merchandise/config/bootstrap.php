...
// Include the CLI bootstrap overrides.
  ...
  if($domain == "localhost"){
     $siteName = 'http://' . $domain . '/2024/df_tst/DrapeFitPHPAli2024/merchandise/';
 ...
 define('HTTP_ROOT_INV', $siteName3);
 define('HTTP_ROOT', $siteName);
  define('SITE_NAME', "Drape Fit");
  define('REFER_NAME', "Drape Fit");
  define('SITE_SHORT_NAME', "Drape");
  define('SITE_LONG_NAME', "Drape Fit");
  define('CURDT', date('Y-m-d h:i:s'));
  define('CURD', date('Y-m-d h:i:s'));
  define('BANNER_IMAGES', 'files/banner_images/');
  define('PRODUCTIMG', 'files/productimg/');
  define('NEWSIMG', 'files/news/');
  define('COVER_PHOTO', 'files/cover_photo/');
  define('PHOTO', 'files/event_photos/');
  define('FEATURE_IMAGES', 'files/featured_images/');
  define('CUSTOMER', 'files/customer/');
  define('SOCIAL_ICON', 'files/social_icon/');
  define('ALBUM', 'files/album/');
  define('EXCEL', 'files/temp_excel/');
  define('IMAGE', 'webroot/images/');
  define('MAN', 'webroot/assets/images/men/');
  define('PRODUCT_IMAGES', 'files/product_img/');
  define('PRODUCT_RECEIPT', 'files/product_recipt/');
define('BARCODE', 'files/barcode/');
define('HELP', 'files/help/');
...
define('GOOGLE_OAUTH_CLIENT_ID', '815751471058-2g648h6ghbs0k3mdu15jm2d8ocb9pbhi.apps.googleusercontent.com');
define('GOOGLE_OAUTH_CLIENT_SECRET', 'URu2bV04oJRDKoAprqdUCa2r');
define('GOOGLE_OAUTH_REDIRECT_URI', HTTP_ROOT . 'googleLoginReturn');
define("GOOGLE_SITE_NAME", 'Drapefit');


define("G_CLINT_ID", '815751471058-6pnfo654v3loq93lddltt8a0an10oiqg.apps.googleusercontent.com');
define("G_SITE_KEY", 'TFxYmIFXnIK_gUA7ZtPmcy9K');
define("G_R_U", 'https://drapefit.com/clients/gmail');
