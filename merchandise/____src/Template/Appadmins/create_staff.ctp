        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <?= $this->Form->create($admin, ['data-toggle' => "validator", 'id' => 'myForm']); ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInputName"> Contact person First Name <span style="color: red;">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="exampleInputName"> Contact person Last Name <span style="color: red;">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInputName"> Contact phone number <span style="color: red;">*</span></label>
                                <?= $this->Form->input('phone', ['placeholder' => "Enter phone number", 'class' => "form-control", 'label' => false, 'kl_virtual_keyboard_secure_input' => "on", 'required' => "required", 'value' => @$editAdmin->phone, 'data-error' => 'Enter first name']); ?>

                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputName"> Website <span style="color: red;">*</span></label>
                                <?= $this->Form->input('website', ['placeholder' => "Enter website", 'class' => "form-control", 'label' => false, 'kl_virtual_keyboard_secure_input' => "on", 'required' => "required", 'value' => @$editAdmin->website, 'data-error' => 'Enter last name']); ?>
                                <div class="help-block with-errors"></div>
                            </div>                        
                        </div>
