...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <?= __(date('F', strtotime('first day of -2 month')) . ' Customer List') ?>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo HTTP_ROOT . 'appadmins' ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?php echo HTTP_ROOT . 'appadmins/prediction' ?>"> <?= __(' Customer List') ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="<?php echo HTTP_ROOT . 'appadmins/two_previous_monthprediction' ?>" class="btn btn-info"><?= date('F', strtotime('first day of -2 month')); ?></a>
                                        ...
                                        <table class="table table-bordered table-striped example3">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Email </th>
                                                    <th>Subs. </th>
                                                    <th><?= date('F', strtotime('first day of -2 month')); ?> Date</th>
                                                    <th>Fit count</th>
                                                    <th>Influenser</th>
                                                    <th>Action </th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?= date('Y-' . date('m', strtotime('first day of -2 month')) . '-d', strtotime($p_c_list->created_dt)); ?></td>
                                                                        <td><?= $p_c_list->count; ?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="cmt-frm">
                    ...
                    <input type="hidden" id="month_year" value="<?=date('Y_').date('m', strtotime('first day of -2 month'));?>" />
