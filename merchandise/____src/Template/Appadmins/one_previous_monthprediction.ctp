...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <?= __(date('F', strtotime('first day of -1 month')) . ' Customer List') ?>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <a href="<?php echo HTTP_ROOT . 'appadmins/one_previous_monthprediction' ?>" class="btn btn-info"><?= date('F', strtotime('first day of -1 month')); ?></a>
                                        ...
                                        <table class="table table-bordered table-striped example3">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Email </th>
                                                    <th>Subs. </th>
                                                    <th><?= date('F', strtotime('first day of -1 month')); ?> Date</th>
                                                    <th>Fit count</th>
                                                    <th>Influencer</th>
                                                    <th>Action </th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><?= date('Y-' . date('m', strtotime('first day of -1 month')) . '-d', strtotime($p_c_list->created_dt)); ?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="cmt-frm">
                    ...
                    <input type="hidden" id="month_year" value="<?=date('Y_').date('m', strtotime('first day of -1 month'));?>" />
